...
function StudentViewCourseDetailsPage() {
  ...
  //     await checkCoursePurchaseInfoService(currentCourseDetailsId);
    ...
    <div className=" mx-auto p-4">
      <div className="bg-gray-900 text-white p-8 rounded-t-lg">
        ...
        <div className="flex items-center space-x-4 mt-2 text-sm">
          <span>Instrutor {studentViewCourseDetails?.instructorName}</span>
          <span>Criado em {studentViewCourseDetails?.date.split("T")[0]}</span>
        ...
        <aside className="w-full md:w-[500px]">
          <Card className="sticky top-4">
            <CardContent className="p-6">
              ...
              <div className="mb-4">
                <span className="text-3xl font-bold">Prévia do curso</span>
              </div>
