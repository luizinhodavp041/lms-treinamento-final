...
import banner from "../../../../src/banner-img.png";
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between py-8 px-4 lg:px-8">
        <div className="lg:w-1/2 lg:pr-12">
          <h1 className="text-4xl font-bold mb-4 pl-10">
            Capacitando seu futuro no transporte coletivo
          </h1>
          <p className="pl-10 text-xl">
            Habilidades essenciais para quem deseja se aperfeiçoar e ser acima
            da média. Comece conosco hoje mesmo!
          </p>
        </div>
